...
class DwarfPlanets:
    """Класс, описывающий карликовые планеты"""

    def __init__(self, radius: float, number_satellites: int):
        """
        Атрибуты:
        :param radius: радиус планеты
        :param number_satellites: количество спутников планеты
        """
...
class PlutoPlanet(DwarfPlanets):
    pass


class CeresPlanet(DwarfPlanets):
    pass
